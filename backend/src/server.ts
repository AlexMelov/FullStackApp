...
import { middlewareHandler } from './middleware/check-authentication.js';
...
server.get(environment.apiRoutes.todos, middlewareHandler, findHandler);
server.post(environment.apiRoutes.todos, middlewareHandler, saveHandler);
server.delete(environment.apiRoutes.todosWithId, middlewareHandler, deleteHandler);
